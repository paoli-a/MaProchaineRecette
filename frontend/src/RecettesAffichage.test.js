...
beforeEach(() => {
  recettes = [
    ...
    },
    {
      ...
      ingredients: [
        { ingredient: "saumon fumé", quantite: "200", unit: "g" },
        { ingredient: "citon vert", quantite: "0,5", unit: "pièce(s)" },
        { ingredient: "vinaigre balsamique", quantite: "2", unit: "cas" },
        { ingredient: "huile d'olive", quantite: "2", unit: "cas" },
        { ingredient: "échalotte", quantite: "1", unit: "pièce(s)" },
        { ingredient: "herbes fraiches", quantite: "1", unit: "cas" },
      ],
      duree: "11 h",
      description:
    ...
    },
    {
      ...
      ingredients: [
        ...
        { ingredient: "farine", quantite: "150", unit: "g" },
        { ingredient: "beurre", quantite: "130", unit: "g" },
        { ingredient: "cassonade", quantite: "120", unit: "g" },
      ],
      duree: "1 h",
      description:
